  ...
  if (pervMinMax !== nextMinMax) {
    if (pervMinMax) {
      if (nextMinMax) {
        ...
        const monthBetweenMinRange = pervMinMax < nextMinMax ? monthBetweenRange(currentMonth, moment(pervMinMax).toDate(), moment(nextMinMax).toDate()) : monthBetweenRange(currentMonth, moment(nextMinMax).toDate(), moment(pervMinMax).toDate());
